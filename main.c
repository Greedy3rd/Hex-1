...
int main(int argc, char *argv[])
{
    ...
    Uint32 vert, rouge, bleu; // des variables pour des couleurs
    ...
    SDL_WM_SetCaption("COUCOU C MOI", NULL); // legende de la fenêtre
    ...
    texte1 = TTF_RenderText_Blended(fontMenu,"COUCOU C ENCORE MOI !",fontBlack);

    // encore une surface
    //rectangle = SDL_CreateRGBSurface(initflags,225,80,video_bpp,0,0,0,0); // une autre surface pour inclure dans l'autre
    //SDL_FillRect(rectangle,NULL,bleu); // un fond rouge
